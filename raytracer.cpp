...
bool intersectPlane(Ray *ray, Intersection *intersection, Object *obj) {
  //!  Calculer l'intersection entre le rayon et le plan(objet) Si pas d'intersection return false

  //!  Si intersection, calculer la valeur t correspondante au point d'intersection
  //!  Verifier si t est entre tmin et tmax pour le rayon sinon return false
  //!  Mettre à jour les paramètres de intersection et ray et renvoyer true
...
bool intersectSphere(Ray *ray, Intersection *intersection, Object *obj) {
    //!  Calculer l'intersection entre le rayon et le sphere(objet) Si pas d'intersection return false
    //!  Si intersection, calculer la valeur t correspondante au point d'intersection
    //!  Verifier si t est entre tmin et tmax pour le rayon sinon return false
    //!  Mettre à jour les paramètres de intersection et ray et renvoyer true
